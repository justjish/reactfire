...
export declare const useAppCheck: typeof firebase.appCheck;
...
export declare const preloadAppCheck: (options: PreloadOptions<App['appCheck']>) => Promise<App['appCheck']>;
